...
ZIPが `/workspaces/focus-route-ios/focus-route-ios-build9-full-20260624.zip` にある場合:

```bash
cd /workspaces/focus-route-ios
unzip -o focus-route-ios-build9-full-20260624.zip
cd focus-route-ios-build9-usual-features-20260624
```
...
cd /workspaces/focus-route-ios
unzip -o focus-route-ios-build9-full-20260624.zip
cp -a focus-route-ios-build9-usual-features-20260624/. .
```
...
git status
git add .
git commit -m "Add usual wording focus features"
git push
```
